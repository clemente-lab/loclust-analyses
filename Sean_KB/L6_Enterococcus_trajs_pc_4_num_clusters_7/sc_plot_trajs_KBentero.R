...
# infp_interp <- paste0(base_path, "L6__Bacteroides_trajs_lego-interp_sig_5_loclust_k5_3pca_R.tsv")
base_path <- "/sc/arion/projects/clemej05a/kevin/loclust/sean/outputs/taxa_trajs/L6_Enterococcus_trajs_pc_4_num_clusters_7/"
...
ggplot() + 
  ...
  labs(x = "Time [Days]", y = "Enterococcus Relative Abundance", color="Diet Mode") +
  scale_x_continuous(breaks=seq(0, 12, by=3), labels=seq(0, 12, by=3)) +
  theme_minimal(base_size=26) 

ggsave(paste(base_path, "Enterococcus_smooth-5.pdf"), height=10, width=12)
...
ggsave(paste(base_path, "Enterococcus_smooth-5_Diet-mean.pdf"), height=10, width=7.75)
...
p <- ggplot() + 
  ...
  labs(x = "Time [Days]", y = "Enterococcus Relative Abundance", color="Diet") +
  scale_x_continuous(breaks=seq(0, 12, by=3), labels=seq(0, 12, by=3)) +
  theme_minimal(base_size=26) 
...
ggsave(paste(base_path, "Enterococcus_smooth-5_Diet-mean-and-clusters_nopoints.pdf"), height=10, width=23)
...
for (mdata in mdata_list) {
  p <- ggplot() + 
    ...
    labs(x = "Time [Days]", y = "Enterococcus Relative Abundance", color=mdata) +
    scale_x_continuous(breaks=seq(0, 12, by=3), labels=seq(0, 12, by=3)) +
    theme_minimal(base_size=26) 
  ...
  ggsave(paste(base_path, "Enterococcus_bL5_", mdata, "-mean-and-clusters.pdf", sep=""), height=10, width=23)
}
...
ggsave(paste(base_path, "Enterococcus_bL5_", mdata, "-mean-and-clusters_yfree.pdf", sep=""), height=10, width=23)
...
# base_path <-"C:/Users/mathr/Documents/GitHub/babies_mg/outputs/allT_L5/otu_table_merged.0-12m.stool.child_L6_trajs_Enterococcus_trajs_lego-interp_sig_5_pc_None_num_clusters_5/"
...
# base_path <- "/sc/arion/projects/clemej05a/kevin/loclust/babies_mg/babies_mg_lego5_outputs/outputs/taxa_trajs_lego_interp/L6__Enterococcus_trajs_lego-interp_sig_4_pc_None_num_clusters_5/"
# infp_interp <- Sys.glob(file.path(base_path, "*_R.tsv"))
# print(infp_interp)
