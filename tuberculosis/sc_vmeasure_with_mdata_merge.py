...
base_dir = "C:/Users/mathr/Documents/GitHub/tb_mmeds_initial/outputs/"
df_v = pd.read_csv(base_dir + "time-corrected-trajs_lego_interp_v-measure_results.tsv", sep='\t')
df_s = pd.read_csv(base_dir + 'longitudinal_tb_jobs_lego7_silhouette_scores.tsv', sep='\t')
