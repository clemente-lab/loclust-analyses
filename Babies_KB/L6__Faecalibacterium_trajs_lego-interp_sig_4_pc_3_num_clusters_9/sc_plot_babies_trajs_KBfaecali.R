...
# infp_interp <- paste0(base_path, "L6__Bacteroides_trajs_lego-interp_sig_5_loclust_k5_3pca_R.tsv")
base_path <- "/sc/arion/projects/clemej05a/kevin/loclust/babies_mg/babies_mg_lego5_outputs/outputs/taxa_trajs_lego_interp/L6__Faecalibacterium_trajs_lego-interp_sig_4_pc_4_num_clusters_8/"
...
ggplot() + 
  ...
  labs(x = "Age [Months]", y = "Faecalibacterium Relative Abundance", color="Delivery Mode") +
...
ggsave(paste(base_path, "Faecalibacterium_smooth-5_delivery-mean.pdf"), height=10, width=7.75)
...
ggsave(paste(base_path, "Faecalibacterium_smooth-5_delivery-mean-and-clusters_nopoints.pdf"), height=10, width=23)
...
for (mdata in mdata_list) {
  p <- ggplot() + 
    ...
    labs(x = "Age [Months]", y = "Faecalibacterium Relative Abundance", color=mdata) +
    scale_x_continuous(breaks=seq(0, 12, by=3), labels=seq(0, 12, by=3)) +
    theme_minimal(base_size=26) 
  ...
  ggsave(paste(base_path, "Faecalibacterium_bL5_", mdata, "-mean-and-clusters.pdf", sep=""), height=10, width=23)
}
...
ggsave(paste(base_path, "Faecalibacterium_bL5_", mdata, "-mean-and-clusters_yfree.pdf", sep=""), height=10, width=23)
...
# base_path <- "/sc/arion/projects/clemej05a/kevin/loclust/babies_mg/babies_mg_lego5_outputs/outputs/taxa_trajs_lego_interp/L6__Faecalibacterium_trajs_lego-interp_sig_4_pc_None_num_clusters_5/"
# infp_interp <- Sys.glob(file.path(base_path, "*_R.tsv"))
# print(infp_interp)
