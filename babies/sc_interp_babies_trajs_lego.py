...
base_path = Path('C:/Users/mathr/Documents/GitHub/babies_mg/otu_tables_and_mapping_files/')
traj_paths = ['taxa_trajs']
# traj_paths = ['taxa_trajs_lego_interp_12_test']
num_pts = 12
...
for folder_name in traj_paths:
    ...
    for t_file in glob(f'{folder}/*.out'):
        ...
        timepoints_list, trajs = determine_traj_interpolation_points(trajs, num_points_to_add=num_pts)
