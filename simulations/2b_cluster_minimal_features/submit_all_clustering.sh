...
#
# After all jobs complete, manually run v-measure calculation:
...
# Create logs directory and clean old logs to prevent accumulation
...
R_METHODS="kml dtwclust traj mfuzz"
R_JOB_IDS=()
...
echo ""
echo "After all jobs complete, manually run v-measure calculation:"
echo "  cd ${SCRIPT_DIR}"
echo "  python calculate_vmeasure.py"
echo ""
