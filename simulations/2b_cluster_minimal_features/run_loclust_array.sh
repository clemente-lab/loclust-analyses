#!/bin/bash
#BSUB -J loclust_METHOD[1-2100]
#BSUB -o logs/loclust_METHOD.out
#BSUB -e logs/loclust_METHOD.err
#BSUB -n 1
...
# METHOD MUST BE SET - this is a template, create copies with actual method names
METHOD="METHOD"
...
OUTPUT_DIR="${TRAJ_DIR/data_potentially_simple/data_minimal_features}/clustering/${METHOD}_k${NUM_CLASSES}"
mkdir -p "$OUTPUT_DIR"
