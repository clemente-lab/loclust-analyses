#!/bin/bash
#BSUB -J loclust_kmeans[1-1740]
#BSUB -o logs/loclust_kmeans.out
#BSUB -e logs/loclust_kmeans.err
#BSUB -n 1
...
#
# Usage:
#   # Replace kmeans in the script with actual method name, then:
...
# kmeans MUST BE SET - this is a template, create copies with actual method names
kmeans="kmeans"
...
OUTPUT_DIR="${TRAJ_DIR/data_potentially_simple/data_minimal_features}/clustering/${kmeans}_k${NUM_CLASSES}"
mkdir -p "$OUTPUT_DIR"
