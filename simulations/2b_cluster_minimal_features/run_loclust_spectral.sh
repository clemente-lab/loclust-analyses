#!/bin/bash
#BSUB -J loclust_spectral[1-1740]
#BSUB -o logs/loclust_spectral.out
#BSUB -e logs/loclust_spectral.err
#BSUB -n 1
...
#
# Usage:
#   # Replace spectral in the script with actual method name, then:
...
# spectral MUST BE SET - this is a template, create copies with actual method names
spectral="spectral"
...
OUTPUT_DIR="${TRAJ_DIR/data_potentially_simple/data_minimal_features}/clustering/${spectral}_k${NUM_CLASSES}"
mkdir -p "$OUTPUT_DIR"
