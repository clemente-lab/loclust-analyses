#!/bin/bash
#BSUB -J loclust_gmm[1-1740]
#BSUB -o logs/loclust_gmm.out
#BSUB -e logs/loclust_gmm.err
#BSUB -n 1
...
#
# Usage:
#   # Replace gmm in the script with actual method name, then:
...
# gmm MUST BE SET - this is a template, create copies with actual method names
gmm="gmm"
...
OUTPUT_DIR="${TRAJ_DIR/data_potentially_simple/data_minimal_features}/clustering/${gmm}_k${NUM_CLASSES}"
mkdir -p "$OUTPUT_DIR"
